  ...
  describe("readUInt8", () => {
    ...
    it("should throw error when reading beyond buffer", () => {
      ...
      expect(() => reader.readUInt8()).toThrow(
        "Cannot read byte at offset 1: buffer too short",
      );
    });
    ...
    it("should throw error on empty buffer", () => {
      ...
      expect(() => reader.readUInt8()).toThrow(BinaryParseError);
      expect(() => reader.readUInt8()).toThrow(
        "Cannot read byte at offset 0: buffer too short",
      );
    });
  });
  ...
  describe("seek", () => {
    ...
    it("should throw error for negative position", () => {
      ...
      expect(() => reader.seek(-1)).toThrow(
        "Cannot seek to position -1: out of bounds",
      );
    });
    ...
    it("should throw error for position beyond buffer", () => {
      ...
      expect(() => reader.seek(2)).toThrow(
        "Cannot seek to position 2: out of bounds",
      );
    });
  });
