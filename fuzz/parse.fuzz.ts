        ...
        for (const filename of filenames) {
          ...
          for (let row = 0; row < parsed.grid.height; row++) {
            ...
            for (let col = 0; col < cellRow.length; col++) {
              ...
              expect(
                cell.isCircled === undefined ||
                  typeof cell.isCircled === "boolean",
              ).toBe(true);
              expect(
                cell.hasRebus === undefined ||
                  typeof cell.hasRebus === "boolean",
              ).toBe(true);
              expect(
                cell.rebusKey === undefined ||
                  typeof cell.rebusKey === "number",
              ).toBe(true);
            }
          }
